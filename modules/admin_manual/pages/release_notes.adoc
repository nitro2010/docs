...
* The https://doc.owncloud.com/server/admin_manual/release_notes.html#developer_manual:webdav_api/trashbin.html[WebDAV Trash bin API] and the https://doc.owncloud.com/server/developer_manual/webdav_api/public_files.html[WebDAV endpoint for public links] (introduced with 10.3.0) have left the tech preview state. 
...
* A new https://doc.owncloud.com/server/latest/developer_manual/core/apis/ocs/user-sync-api.html[OCS User Sync API] to trigger user sync from external user backends has been added. 
